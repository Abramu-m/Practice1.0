...
(function() {
    ...
    $(document).on('click', '#modalAddDrugAllergyBtn', function() {
        ...
        // Open detail modal for new allergy, passing the real medication id and generic name
        const genericName = selectedData.medication ? selectedData.medication.generic_name : medicationName;
        openDrugAllergyDetailModal({medication_id: parseInt(medicationId), substance_name: genericName}, false);
    });
    ...
    function openDrugAllergyDetailModal(allergy, isEdit) {
        ...
        $('#modalDrugMedicationId').val(allergy.medication_id || '');
    ...
    $(document).on('click', '#saveModalDrugAllergyBtn', function() {
        ...
        const medicationId = $('#modalDrugMedicationId').val();
        const payload = {
            _token: $('input[name="_token"]').val(),
        ...
        if (medicationId) payload.medication_id = parseInt(medicationId);
