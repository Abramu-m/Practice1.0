...
class MedicalServiceController extends Controller
{
    ...
    public function create()
    {
        ...
        $investigationForms = InvestigationForm::orderBy('name')->get();
        return view('medical_services.create', compact('categories', 'resultTemplates', 'investigationForms'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'loinc_code_id' => 'nullable|exists:lab_codes,id',
            'snomed_code_id' => 'nullable|exists:lab_codes,id',
    ...
    public function edit(MedicalService $medicalService)
    {
        ...
        $resultTemplates = ResultTemplate::active()->ordered()->get();
        $investigationForms = InvestigationForm::orderBy('name')->get();
        return view('medical_services.edit', compact('medicalService', 'categories', 'resultTemplates', 'investigationForms'));
    }
    ...
    public function pricing()
    {
        $services = MedicalService::with('serviceCategory')
            ->orderBy('name')
            ->get(['id', 'name', 'service_category_id', 'selling_price', 'discount_percentage', 'is_active']);

        return view('medical_services.pricing', compact('services'));
    }

    public function updatePrice(Request $request, MedicalService $medicalService)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Price updated for ' . $medicalService->name,
        ]);
    }
}
