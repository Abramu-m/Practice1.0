...
class MedicationCashSaleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('medication_cash_sales.index', compact('dateFrom', 'dateTo'));
    }
    ...
    public function getMedicationPricing(Request $request)
    {
        ...
        if ($searchQuery && !$medicationId) {
            ...
            $medicationsWithPricing = $medications->map(function($medication) {
                ...
                return [
                    ...
                    'unit_price' => (float) $medication->selling_price,
                    'pricing_exists' => $medication->selling_price > 0,
        ...
        if ($medicationId) {
            ...
            return response()->json([
                ...
                'unit_price' => $medication ? (float) $medication->selling_price : 0,
                'pricing_exists' => $medication && $medication->selling_price > 0,
                'available_stock' => $availableStock,
                'in_stock' => $availableStock > 0,
            ]);
        }
