...
class PrescriptionController extends Controller
{
    ...
    {   
        try {
                ...
                $insurance_covered_amount = $pricing['insurance_covered_amount'] * $request->quantity;

                // Update prescription with new data and pricing
                $validatedData['cash_amount'] = $cash_amount;
                $validatedData['insurance_covered_amount'] = $insurance_covered_amount;
            ...
            return response()->json(['success' => false, 'message' => 'Failed to update prescription.'], 500);
        }
    }
