...
class ClinicalController extends Controller
{
    ...
    public function searchMedicalServices(Request $request): JsonResponse
    {
        try {
            ...
            $servicesQuery = MedicalService::with(['serviceCategory', 'currentPricing' => function($query) use ($patientCategoryId) {
            ...
            $services = $servicesQuery->get()->map(function($service) use ($patientCategoryId) {
                ...
                return [
                    ...
                    'price' => $pricing ? $pricing->selling_price : null,
                    'markup_percentage' => $pricing ? $pricing->markup_percentage : null,
                    'discount_percentage' => $pricing ? $pricing->discount_percentage : null,
