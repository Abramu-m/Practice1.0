...
{
    /**
     * Build parasitology lab report
     */
    public function buildReport(): array
    {
        $investigations = $this->getParasitologyInvestigations();
    ...
    /**
     * Get parasitology investigations
     */
    private function getParasitologyInvestigations()
    {
        return Investigation::join('patient_visits', 'investigations.visit_id', '=', 'patient_visits.id')
            ...
            ->where(function ($query) {
                $query->where('service_categories.name', 'LIKE', '%Parasitology%')
                    ->orWhere('medical_services.name', 'LIKE', '%Stool%')
                    ->orWhere('medical_services.name', 'LIKE', '%Urinalysis%');
            })
