...
class Investigation extends Model
{
    ...
    protected $fillable = [
        ...
        'medical_service_id',
        'quantity',
        'cash_amount', // renamed from total_price
    ...
    /**
     * Get the form data submitted when this investigation was ordered
     */
    public function formData()
    {
        return $this->hasOne(InvestigationFormData::class);
    }
    ...
    {
        return $this->cash_amount - ($this->insurance_covered_amount ?? 0);
    }
    ...
    {
        return 'Tsh' . number_format($this->cash_amount + $this->insurance_covered_amount, 2);
    }
