...
class Medication extends Model
{
    ...
    public function pricingMap()
    {
        return $this->hasMany(MedicationInsuranceMap::class);
    }

    /**
     * Get medication pricing records
     */
    public function pricing(int $patientCategoryId)
    {
        return app(\App\Services\PricingService::class)
            ->resolve($this, $patientCategoryId);
    }
    ...
    public function dosageLimits()
    {
        return $this->hasMany(\App\Models\CdsDosageLimit::class, 'medication_id');
    }

    public function drugClasses()
    {
        return $this->belongsToMany(\App\Models\DrugClass::class, 'drug_class_medication');
    }
}
