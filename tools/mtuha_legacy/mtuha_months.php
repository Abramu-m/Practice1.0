...
<table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%; color:black">
   <thead>
        <tr>
            <td colspan="24"><strong>Taarifa ya Mwezi kutoka OPD</strong></td>

        </tr>
 
        <tr>
            <td colspan="6">Jina la Kituo: <?php echo $row['description']; ?></td>
            <td colspan="3">Wilaya: <?php echo $row['wilaya']; ?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td colspan="3">Mkoa: <?php echo $row['mkoa']; ?></td>
            <td>&nbsp;</td>
            <td>Mwezi:</td>
            <td>&nbsp;</td>
     ...
     <tbody>
        ...
        <tr style="background-color: grey;">
            <td>&nbsp;XVIII</td>
            <td colspan="23">Symptoms, Signs and Abnormal Clinical and Laboratory Findings, Not Elsewhere Classified</td>
        </tr>
        <?php while($row_diagnoses = mysqli_fetch_array($symptoms)){?>
        <tr>
            <td><?php echo $id=$row_diagnoses['id'];?></td>
            <td colspan="5"><?php echo $row_diagnoses['catname'];?></td>
            <td><?php echo $i=diagnoses(1,$year,$month,$id,0,30);?></td>
