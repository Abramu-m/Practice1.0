            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($category->tariffs_table)
                                <code>{{ $category->tariffs_table }}</code>
                            @elseif($category->type === 'insurance')
                                <span class="badge bg-warning text-black">Not set</span>
                            @else
...
$(document).ready(function() {
    $('.table').DataTable({
        ...
        language: {
            search: "Search patient categories:",
