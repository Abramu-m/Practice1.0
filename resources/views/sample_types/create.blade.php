        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Create Sample Type</h3>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sample_types.store') }}">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="collection_instructions" 
                                              ...
                                              rows="3" 
                                              placeholder="Instructions for sample collection">{{ old('collection_instructions') }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="storage_requirements" 
                                              ...
                                              rows="2" 
                                              placeholder="e.g., Room temperature, Refrigerated, Frozen">{{ old('storage_requirements') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Create Sample Type
                                </button>
                                <a href="{{ route('sample_types.index') }}" class="btn btn-secondary">
