        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Medication Pricing</h3>
                ...
                <form action="{{ route('medication-pricing.update', $medicationPricing->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select class="form-control @error('medication_id') is-invalid @enderror" 
                                        ...
                                        @foreach($medications as $medication)
                                            <option value="{{ $medication->id }}" 
                                                {{ old('medication_id', $medicationPricing->medication_id) == $medication->id ? 'selected' : '' }}>
                                                {{ $medication->name }}
                                    ...
                                    <select class="form-control @error('patient_category_id') is-invalid @enderror" 
                                        ...
                                        @foreach($patientCategories as $category)
                                            <option value="{{ $category->id }}" 
                                                {{ old('patient_category_id', $medicationPricing->patient_category_id) == $category->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('selling_price') is-invalid @enderror" 
                                               id="selling_price" name="selling_price" value="{{ old('selling_price', $medicationPricing->selling_price) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('markup_percentage') is-invalid @enderror" 
                                               id="markup_percentage" name="markup_percentage" value="{{ old('markup_percentage', $medicationPricing->markup_percentage) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('discount_percentage') is-invalid @enderror" 
                                               id="discount_percentage" name="discount_percentage" value="{{ old('discount_percentage', $medicationPricing->discount_percentage) }}" 
                                               step="0.01" min="0" max="100">
                                        <div class="input-group-append">
                                            <span class="input-group-text">%</span>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('effective_from') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_from', $medicationPricing->effective_from->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('effective_to') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_to', $medicationPricing->effective_to?->format('Y-m-d')) }}">
                                    @error('effective_to')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1"
                                               {{ old('is_active', $medicationPricing->is_active) ? 'checked' : '' }}>
