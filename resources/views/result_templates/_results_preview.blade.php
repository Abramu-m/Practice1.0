...
@php
    // Build sample rows from well-known template codes
    $codeSamples = [
        'single_numeric_lab' => [
    ...
    $isNarrative = $code === 'narrative_lab';
    $isGenericProcedure = str_contains($code, 'procedure') || str_contains($code, 'imaging') || str_contains($code, 'general');
@endphp
