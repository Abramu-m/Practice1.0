                                    ...
                                    <select name="service_category_id" 
                                        ...
                                        @foreach($serviceCategories as $category)
                                            <option value="{{ $category->id }}" 
                                                {{ old('service_category_id', $resultTemplate->service_category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('investigation_type', $resultTemplate->investigation_type) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="json_type_container">
                                        <textarea name="template_fields" 
                                                  ...
                                                  style="font-family: 'Monaco', 'Menlo', 'Ubuntu Mono', monospace; font-size: 13px;">{{ old('template_fields', $resultTemplate->template_fields ? json_encode($resultTemplate->template_fields, JSON_PRETTY_PRINT) : '') }}</textarea>
                                    </div>
