        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Medical Service Pricing</h3>
                ...
                <form action="{{ route('medical-service-pricing.update', $medicalServicePricing) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select class="form-control @error('medical_service_id') is-invalid @enderror" 
                                        ...
                                        @foreach($medicalServices as $service)
                                            <option value="{{ $service->id }}" 
                                                {{ old('medical_service_id', $medicalServicePricing->medical_service_id) == $service->id ? 'selected' : '' }}>
                                                {{ $service->name }}
                                    ...
                                    <select class="form-control @error('patient_category_id') is-invalid @enderror" 
                                        ...
                                        @foreach($patientCategories as $category)
                                            <option value="{{ $category->id }}" 
                                                {{ old('patient_category_id', $medicalServicePricing->patient_category_id) == $category->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('selling_price') is-invalid @enderror" 
                                               ...
                                               value="{{ old('selling_price', $medicalServicePricing->selling_price) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('markup_percentage') is-invalid @enderror" 
                                               ...
                                               value="{{ old('markup_percentage', $medicalServicePricing->markup_percentage) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('discount_percentage') is-invalid @enderror" 
                                               ...
                                               value="{{ old('discount_percentage', $medicalServicePricing->discount_percentage) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('effective_from') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_from', optional($medicalServicePricing->effective_from)->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('effective_to') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_to', optional($medicalServicePricing->effective_to)->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              id="notes" name="notes" rows="3" maxlength="1000">{{ old('notes', $medicalServicePricing->notes) }}</textarea>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" 
                                               ...
                                               {{ old('is_active', $medicalServicePricing->is_active) ? 'checked' : '' }}>
