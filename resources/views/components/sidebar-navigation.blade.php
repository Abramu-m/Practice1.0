...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!-- Pharmacy Management -->
        <li class="nav-item {{ request()->routeIs('medication-insurance-map.*') || request()->routeIs('medication-ledger.*') || request()->routeIs('medications.*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->routeIs('medication-insurance-map.*') || request()->routeIs('medication-ledger.*') || request()->routeIs('medications.*') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('medication-insurance-map.index') }}" class="nav-link {{ request()->routeIs('medication-insurance-map.*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
