...
@section('main_content')
    ...
    @if($systemAlerts['low_stock'] > 0 || $systemAlerts['pending_users'] > 0 || $systemAlerts['pending_requisitions'] > 0)
    <div class="row mb-4">
        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">TSh {{ number_format($todaysRevenue, 0) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
