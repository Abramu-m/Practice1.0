                                ...
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>Tsh {{ number_format($investigation->total_price, 2) }}</strong></td>
                                        </tr>
                                        @if($investigation->insurance_covered_amount > 0)
                                            <tr>
                                                <td><strong>Insurance Covered:</strong></td>
                                                <td class="text-success">Tsh {{ number_format($investigation->insurance_covered_amount, 2) }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Effective Price:</strong></td>
                                                <td class="text-info"><strong>Tsh {{ number_format($investigation->effective_price, 2) }}</strong></td>
                                            </tr>
                                        @endif
                                    </table>
                                </div>
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <p class="timeline-text">
                                                        ...
                                                        @if($investigation->amount_paid && $investigation->amount_paid != $investigation->total_price)
                                                            <br><small class="text-muted">Amount paid: Tsh {{ number_format($investigation->amount_paid, 2) }}</small>
                                                        @endif
                                                    </p>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    @foreach($investigation->investigationConsumptions as $consumption)
                                                        <tr>
                                                            ...
                                                            <td>Tsh {{ number_format($consumption->cost_per_unit * $consumption->quantity_used, 2) }}</td>
