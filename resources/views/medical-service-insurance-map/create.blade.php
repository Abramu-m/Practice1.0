        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add Medical Service Insurance Mapping</h3>
                ...
                <form action="{{ route('medical-service-insurance-map.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2-service @error('medical_service_id') is-invalid @enderror"
                                            id="medical_service_id" name="medical_service_id" required style="width: 100%;">
