...
@section('Content_Description')
    {{ 'Modify the consultation fee structure for doctor, patient category, and visit type combination.' }}
@endsection
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="0.01" min="0" max="999999.99" 
                                           ...
                                           id="fee_amount" name="fee_amount" 
                                           value="{{ old('fee_amount', $consultationFee->fee_amount) }}" 
