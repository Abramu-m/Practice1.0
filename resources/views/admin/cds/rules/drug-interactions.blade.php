    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3">💊 Drug Interaction Rules</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Drug Interaction Rules</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Drug Interaction Rules ({{ $rules->total() }} total)</h5>
                </div>
