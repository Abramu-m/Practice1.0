...
@section('page_title', 'Configure — Clinical Chemistry Report')
...
<div class="container">
    ...
    <div class="page-title-box d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="page-title mb-0">Clinical Chemistry — Report Configuration</h4>
            <p class="text-muted mb-0 mt-1">Ramani ya Huduma za Maabara kwa Taarifa ya Kemia ya Damu</p>
        </div>
        <a href="{{ route('admin.reports.lab-clinical-chemistry') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="alert alert-info">
        ...
        <br>
        <strong>CSF</strong> and <strong>Body fluids</strong> rows (Total, Glucose, Protein) are not
        configurable yet and will always show 0 until dedicated lab services are set up.
    </div>

    <form method="POST" action="{{ route('admin.lab-settings.clinical-chemistry.update') }}">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('admin.reports.lab-clinical-chemistry') }}" class="btn btn-outline-secondary ms-2">
                Back to Report
            </a>
        </div>
