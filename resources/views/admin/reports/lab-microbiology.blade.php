...
@section('page_title', 'Microbiology Monthly Report')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body py-2">
                    <form method="GET" action="{{ route('admin.reports.lab-microbiology') }}" class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <a href="{{ route('admin.lab-settings.microbiology.index') }}" class="btn btn-sm btn-secondary ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <h5 class="fw-bold mb-0">MICROBIOLOGY MONTHLY REPORT</h5>
                    </div>
                    ...
                    <table class="table table-bordered table-sm">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center" style="width:80px">POSITIVE</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($rows as $row)
                            <tr class="{{ $row->is_bold ? 'section-header-row' : '' }}">
                                <td>{{ $row->row_label }}</td>
                                <td class="text-center">{{ $totals[$row->row_key] !== null ? $totals[$row->row_key] : '' }}</td>
                                <td class="text-center">{{ $positives[$row->row_key] !== null ? $positives[$row->row_key] : '' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
