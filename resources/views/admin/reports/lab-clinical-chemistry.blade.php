...
@section('page_title', 'Clinical Chemistry Lab Report')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="page-title">
                <i class="fas fa-flask"></i> Clinical Chemistry Lab Report
            </h1>
            <p class="text-muted">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.reports.lab-clinical-chemistry') }}" class="form-inline">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">Clinical Chemistry Investigations</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($investigations as $inv)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $inv['normal_range'] ?? '-' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center text-muted">No clinical chemistry investigations found this month</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
