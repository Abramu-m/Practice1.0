...
@section('page_title', 'Clinical Chemistry Monthly Report')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body py-2">
                    <form method="GET" action="{{ route('admin.reports.lab-clinical-chemistry') }}" class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <a href="{{ route('admin.lab-settings.clinical-chemistry.index') }}" class="btn btn-sm btn-secondary ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <h5 class="fw-bold mb-0">CLINICAL CHEMISTRY MONTHLY REPORT</h5>
                    </div>
