...
@section('page_title', 'Serology Lab Report')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="page-title">
                <i class="fas fa-flask"></i> Serology Lab Report
            </h1>
            <p class="text-muted">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.reports.lab-serology') }}" class="form-inline">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">Serology Investigations</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">No serology investigations found this month</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
