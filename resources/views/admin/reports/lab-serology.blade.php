...
@section('page_title', 'Serology Monthly Report')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body py-2">
                    <form method="GET" action="{{ route('admin.reports.lab-serology') }}" class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <a href="{{ route('admin.lab-settings.serology.index') }}" class="btn btn-sm btn-secondary ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <h5 class="fw-bold mb-0">SEROLOGY MONTHLY REPORT</h5>
                    </div>
