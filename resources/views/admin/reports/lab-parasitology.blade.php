...
@section('page_title', 'Parasitology Monthly Report')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body py-2">
                    <form method="GET" action="{{ route('admin.reports.lab-parasitology') }}" class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <a href="{{ route('admin.lab-settings.parasitology.index') }}" class="btn btn-sm btn-secondary ms-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        ...
                        <h5 class="fw-bold mb-0">PARASITOLOGY MONTHLY REPORT</h5>
                    </div>
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                ...
                                <tr class="section-header-row">
                                    <td colspan="3">{{ $row->row_label }}</td>
                                </tr>
                                @else
                                <tr>
                                    <td>{{ $row->row_label }}</td>
                                    <td class="text-center">{{ $totals[$row->row_key] ?? '' }}</td>
                                    <td class="text-center">{{ $positives[$row->row_key] ?? '' }}</td>
                                </tr>
                                @endif
                            @endforeach
                        </tbody>
