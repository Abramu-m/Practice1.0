...
@section('page_title', 'Hematology Lab Report')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="page-title">
                <i class="fas fa-flask"></i> Hematology Lab Report
            </h1>
            <p class="text-muted">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.reports.lab-hematology') }}" class="form-inline">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">Hematology Investigations</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center text-muted">No hematology investigations found this month</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
