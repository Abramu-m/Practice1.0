...
@section('page_title', 'Monthly Lab Reports')
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            <h1 class="page-title">
                <i class="fas fa-flask"></i> Monthly Lab Reports
            </h1>
            <p class="text-muted">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.reports.monthly-lab-reports') }}" class="form-inline">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h6 class="mb-0">Tests by Type</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($by_test_type as $test)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $test['total_tests'] }}</td>
                                        <td class="text-center"><span class="badge badge-success">{{ $test['completed_tests'] }}</span></td>
                                        <td class="text-center"><span class="badge badge-warning">{{ $test['pending_tests'] }}</span></td>
                                        <td class="text-center">{{ $test['completion_rate'] }}%</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">No tests conducted this month</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">Tests by Category</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2" class="text-center text-muted">No test categories found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-0"><strong>Avg Completion:</strong> {{ $completion_rate }}%</p>
                </div>
            </div>
        </div>
    </div>
