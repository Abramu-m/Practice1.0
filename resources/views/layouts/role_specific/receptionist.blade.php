<!-- Reception Dashboard -->
<li class="nav-item">
  <a href="{{ route('dashboard.receptionist') }}" class="nav-link nav-header">
...
<li class="nav-item has-treeview">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
      <a href="{{ url('readyInvResults') }}" class="nav-link nav-sub-item">
...
<li class="nav-item has-treeview">
  ...
  <ul class="nav nav-treeview">
    ...
    <li class="nav-item">
      <a href="{{ url('pharmacy_cash_sales') }}" class="nav-link nav-sub-item">
...
<li class="nav-item has-treeview">
  ...
  <ul class="nav nav-treeview">
    <li class="nav-item">
      <a href="{{ url('signature1') }}" class="nav-link nav-sub-item">
