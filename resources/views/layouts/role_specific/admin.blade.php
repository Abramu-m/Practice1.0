              ...
              <!-- Human Resources -->
              <li class="nav-item has-treeview {{ nav_menu_open_class(['hr.*']) }}">
                <a href="#" class="nav-link nav-header {{ nav_active_class(['hr.*']) }}">
                ...
                <ul class="nav nav-treeview" style="{{ nav_display_style(['hr.*']) }}">
                  <li class="nav-item">
                    <a href="{{ route('hr.dashboard') }}" class="nav-link nav-sub-item {{ nav_active_class(['hr.dashboard']) }}">
                      <i class="nav-icon bi bi-speedometer2 text-primary"></i>
                      <p>HR Dashboard</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="{{ route('hr.settings.paye-bands.index') }}" class="nav-link nav-sub-item {{ nav_active_class(['hr.settings.paye-bands.*']) }}">
                      <i class="nav-icon bi bi-percent text-warning"></i>
                      <p>PAYE Tax Bands</p>
                    </a>
                  </li>
                </ul>
