                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-check text-success mr-2"></i>Medications</li>
                                        <li><i class="fas fa-check text-success mr-2"></i>Medical Equipment</li>
                                        <li><i class="fas fa-check text-success mr-2"></i>Disposable Items</li>
                                        <li><i class="fas fa-check text-success mr-2"></i>Laboratory Supplies</li>
                                        <li><i class="fas fa-check text-success mr-2"></i>Emergency Supplies</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-warning">Tips:</h5>
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-star text-warning mr-2"></i>Keep names concise but descriptive</li>
                                        <li><i class="fas fa-star text-warning mr-2"></i>Use consistent naming conventions</li>
                                        <li><i class="fas fa-star text-warning mr-2"></i>Avoid special characters</li>
                                        <li><i class="fas fa-star text-warning mr-2"></i>Consider future needs when naming</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
