...
$params = [
    [
        ...
        'options' => [
            'Negative',
            'Positive <1 ng/ml',
            'Positive >1 ng/ml , <4 ng/ml',
            'Positive >4 ng/ml',
            'Positive >4 ng/ml , <10 ng/ml',
            'Positive ~10 ng/ml',
            'Positive >10 ng/ml',
        ],
        'normal'  => ['Negative'],
        'critical'=> ['Positive >10 ng/ml'],
    ],
];
$existingParams = [];
...
<div class="result-template-container" style="background-color:#fff;padding:15px;border-radius:5px;">
    ...
    <div class="alert alert-info mt-3 py-2 px-3" style="font-size:0.82em;">
        ...
        Negative &nbsp;|&nbsp; Positive &lt;1 ng/ml &nbsp;|&nbsp; Positive &gt;1–4 ng/ml &nbsp;|&nbsp; Positive &gt;4 ng/ml &nbsp;|&nbsp; Positive &gt;4–10 ng/ml &nbsp;|&nbsp; Positive ~10 ng/ml &nbsp;|&nbsp; Positive &gt;10 ng/ml (urologist referral recommended)
    </div>
    <div class="card mt-3">
