{{-- Peripheral Blood Smear for Microfilaria --}}
@php
$params = [
    [
        'name'    => 'Microfilaria',
    ...
    [
        'name'    => 'Density',
        'options' => ['Not Applicable', 'Rare', 'Few', 'Moderate', 'Many'],
        'normal'  => ['Not Applicable'],
        'critical'=> ['Many'],
    ],
    [
        'name'    => 'Species',
        'options' => ['Not Applicable', 'Wuchereria bancrofti', 'Brugia malayi', 'Loa loa', 'Mansonella spp.', 'Unidentified'],
        'normal'  => ['Not Applicable'],
        'critical'=> [],
    ],
];
...
<div class="result-template-container" style="background-color:#fff;padding:15px;border-radius:5px;">
    <div class="text-center mb-3">
        <h6 class="text-primary"><i class="fas fa-microscope"></i> PBS – Microfilaria</h6>
        <small class="text-muted">Peripheral blood smear examination for microfilariae</small>
    </div>
        ...
        <table class="table table-bordered table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-select form-select-sm" id="mf-status-{{ $idx }}" style="background:#f0f0f0;pointer-events:none;cursor:not-allowed;appearance:none;" tabindex="-1" name="parameters[{{ $idx }}][status]">
