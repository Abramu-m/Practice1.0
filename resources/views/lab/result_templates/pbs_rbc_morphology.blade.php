{{-- PBS – RBC Morphology Result Template --}}
@php
$params = [
    [
        'name'    => 'RBC Size',
        'options' => ['Normocytic', 'Microcytic', 'Macrocytic', 'Anisocytosis'],
        'normal'  => ['Normocytic'],
        'critical'=> [],
    ],
    [
        'name'    => 'RBC Colour',
        'options' => ['Normochromic', 'Hypochromic', 'Hyperchromic', 'Polychromasia'],
        'normal'  => ['Normochromic'],
        'critical'=> [],
    ],
    [
        'name'    => 'RBC Shape',
        'options' => ['Normal', 'Poikilocytosis', 'Target cells', 'Sickle cells', 'Spherocytes', 'Elliptocytes', 'Schistocytes', 'Tear-drop cells', 'Burr cells'],
        'normal'  => ['Normal'],
        'critical'=> ['Sickle cells', 'Schistocytes'],
    ],
    [
        'name'    => 'RBC Inclusions',
        'options' => ['None', 'Howell-Jolly bodies', 'Basophilic stippling', 'Malaria parasites', 'Pappenheimer bodies'],
        'normal'  => ['None'],
        'critical'=> ['Malaria parasites'],
    ],
    [
        'name'    => 'WBCs',
        'options' => ['Normal', 'Leucocytosis', 'Leucopenia', 'Left shift'],
        'normal'  => ['Normal'],
        'critical'=> [],
    ],
    [
        'name'    => 'Platelets',
        'options' => ['Normal', 'Thrombocytosis', 'Thrombocytopenia'],
        'normal'  => ['Normal'],
        'critical'=> ['Thrombocytopenia'],
    ],
    [
        'name'    => 'Overall Impression',
        'options' => ['Normal', 'Normocytic normochromic anaemia', 'Microcytic hypochromic anaemia', 'Macrocytic anaemia', 'Haemolytic picture', 'Sickle cell disease', 'Other'],
        'normal'  => ['Normal'],
        'critical'=> ['Sickle cell disease', 'Haemolytic picture'],
    ],
];
$existingParams = [];
...
<div class="result-template-container" style="background-color:#fff;padding:15px;border-radius:5px;">
    <div class="text-center mb-3">
        <h6 class="text-primary"><i class="fas fa-microscope"></i> PBS – RBC Morphology</h6>
        <small class="text-muted">Peripheral blood smear — red cell morphology assessment</small>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-select form-select-sm" name="parameters[{{ $idx }}][value]"
                                ...
                                onchange="multiOptStatus(this, 'rbcm')">
                    ...
                    <td>
                        <select class="form-select form-select-sm" id="rbcm-status-{{ $idx }}" style="background:#f0f0f0;pointer-events:none;cursor:not-allowed;appearance:none;" tabindex="-1" name="parameters[{{ $idx }}][status]">
