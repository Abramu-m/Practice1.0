...
$params = [
    ...
    [
        'name'    => 'Species',
        'options' => ['Not Applicable', 'P. falciparum', 'P. vivax', 'P. malariae', 'P. ovale', 'P. knowlesi', 'Mixed'],
        'normal'  => ['Not Applicable'],
        'critical'=> ['P. falciparum', 'Mixed'],
    ],
    [
        'name'    => 'Parasitemia',
        'options' => ['Negative', '+', '++', '+++', '++++'],
    ...
    [
        'name'    => 'Stage',
        'options' => ['Not Applicable', 'Ring', 'Trophozoite', 'Schizont', 'Gametocyte'],
        'normal'  => ['Not Applicable'],
        'critical'=> ['Schizont'],
    ],
];
...
<div class="result-template-container" style="background-color:#fff;padding:15px;border-radius:5px;">
    <div class="text-center mb-3">
        <h6 class="text-primary"><i class="fas fa-microscope"></i> PBS – Malaria Parasites</h6>
        <small class="text-muted">Peripheral blood smear examination for malaria parasites</small>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-select form-select-sm" name="parameters[{{ $idx }}][value]"
                                ...
                                onchange="multiOptStatus(this, 'mal')">
                    ...
                    <td>
                        <select class="form-select form-select-sm" id="mal-status-{{ $idx }}" style="background:#f0f0f0;pointer-events:none;cursor:not-allowed;appearance:none;" tabindex="-1" name="parameters[{{ $idx }}][status]">
