        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Edit Medical Service</h3>
                    <div>
                        <a href="{{ route('medical_services.show', $medicalService) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('medical_services.update', $medicalService) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('name', $medicalService->name) }}" 
                                           required>
                                    @error('name')
                                    ...
                                    <select name="service_category_id" 
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" 
                                                    {{ old('service_category_id', $medicalService->service_category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('turnaround_time_hours', $medicalService->turnaround_time_hours) }}" 
                                           min="0">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" 
                                              ...
                                              rows="3">{{ old('description', $medicalService->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('min_value', $medicalService->min_value) }}" 
                                           step="0.0001"
                                           placeholder="e.g., 3.5">
                                    @error('min_value')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('max_value', $medicalService->max_value) }}" 
                                           step="0.0001"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('unit', $medicalService->unit) }}" 
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               {{ old('requires_sample', $medicalService->requires_sample) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12" id="sample_type_container" style="display: {{ old('requires_sample', $medicalService->requires_sample) ? 'block' : 'none' }};">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('sample_type', $medicalService->sample_type) }}" 
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="preparation_instructions" 
                                              ...
                                              rows="3" 
                                              placeholder="Instructions for patient preparation (e.g., fasting requirements)">{{ old('preparation_instructions', $medicalService->preparation_instructions) }}</textarea>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" 
                                               ...
                                               class="form-check-input" 
                                               value="1"
                                               {{ old('requires_form', $medicalService->requires_form) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12" id="form_type_container" style="display: {{ old('requires_form', $medicalService->requires_form) ? 'block' : 'none' }};">
                                <div class="mb-3">
                                    <label for="form_type" class="form-label">Form Type</label>
                                    <select name="form_type" id="form_type"
                                            class="form-select @error('form_type') is-invalid @enderror">
                                        <option value="">— Select a form —</option>
                                        @foreach($investigationForms as $invForm)
                                            @php $selected = old('form_type', $medicalService->form_type) === $invForm->blade_view @endphp
                                            <option value="{{ $invForm->blade_view }}" {{ $selected ? 'selected' : '' }}>
                                                {{ $invForm->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input type="checkbox" 
                                               ...
                                               class="form-check-input" 
                                               value="1"
                                               {{ old('is_active', $medicalService->is_active) ? 'checked' : '' }}>
