    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">
            <i class="fa fa-edit"></i> Edit Medication Batch
          </h3>
        ...
        <div class="card-body">
          <form action="{{ route('medication-ledger.update', $batch->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="mb-3">
                  ...
                  <select name="medication_id" id="medication_id" class="form-control @error('medication_id') is-invalid @enderror" required>
                    ...
                    @foreach($medications as $medication)
                      <option value="{{ $medication->id }}" {{ old('medication_id', $batch->medication_id) == $medication->id ? 'selected' : '' }}>
                        {{ $medication->name }}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="goods_received_note_id" id="goods_received_note_id" class="form-control @error('goods_received_note_id') is-invalid @enderror">
                    ...
                    @foreach($grns as $grn)
                      <option value="{{ $grn->id }}" {{ old('goods_received_note_id', $batch->goods_received_note_id) == $grn->id ? 'selected' : '' }}>
                        GRN #{{ $grn->id }} - {{ $grn->date }}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="supplier_name" id="supplier_name" 
                         ...
                         value="{{ old('supplier_name', $batch->supplier_name) }}">
                  @error('supplier_name')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <input type="text" name="initial_quantity" id="initial_quantity" 
                         ...
                         value="{{ old('initial_quantity', $batch->initial_quantity) }}" min="1" required>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="cost_per_unit" id="cost_per_unit" 
                           ...
                           value="{{ old('cost_per_unit', $batch->cost_per_unit) }}" step="0.01" min="0">
                    @error('cost_per_unit')
                      <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="total_cost" id="total_cost" 
                           ...
                           value="{{ old('total_cost', $batch->total_cost) }}" step="0.01" min="0" readonly>
                    @error('total_cost')
                      <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                  </div>
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="date" name="manufacture_date" id="manufacture_date" 
                         ...
                         value="{{ old('manufacture_date', $batch->manufacture_date?->format('Y-m-d')) }}">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                    ...
                    <option value="damaged" {{ old('status', $batch->status) == 'damaged' ? 'selected' : '' }}>Damaged</option>
