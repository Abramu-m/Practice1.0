        ...
        <div class="col-md-3">
            <div class="info-box bg-success">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Tsh {{ number_format($summary['total_income'], 2) }}</span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="info-box bg-danger">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Tsh {{ number_format($summary['total_expenses'], 2) }}</span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="info-box {{ $summary['net_balance'] >= 0 ? 'bg-success' : 'bg-warning' }}">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Tsh {{ number_format($summary['net_balance'], 2) }}</span>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="{{ $transaction->transaction_type == 'income' ? 'text-success' : 'text-danger' }}">
                                    {{ $transaction->transaction_type == 'income' ? '+' : '-' }}Tsh {{ number_format($transaction->amount, 2) }}
                                </span>
                            </td>
                            <td>
