                                ...
                                <div class="col-md-6">
                                    <div class="info-box bg-success">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">${{ number_format($transaction->patient_paid_amount, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-box bg-info">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">${{ number_format($transaction->insurance_covered_amount, 2) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
