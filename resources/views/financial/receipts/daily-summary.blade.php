    ...
    <div class="summary-container">
        ...
        <div class="metrics-grid">
            <div class="metric-card">
                ...
                <div class="metric-value money">${{ number_format($total_revenue, 2) }}</div>
            </div>
            <div class="metric-card">
            ...
            <div class="metric-card">
                ...
                <div class="metric-value money">${{ number_format($patient_payments, 2) }}</div>
            </div>
            <div class="metric-card">
                <div class="metric-title">Insurance Coverage</div>
                <div class="metric-value money">${{ number_format($insurance_payments, 2) }}</div>
            </div>
            <div class="metric-card">
                <div class="metric-title">Average Transaction</div>
                <div class="metric-value money">
                    ${{ $total_transactions > 0 ? number_format($total_revenue / $total_transactions, 2) : '0.00' }}
                </div>
            </div>
            <div class="metric-card">
                <div class="metric-title">Consultation Revenue</div>
                <div class="metric-value money">${{ number_format($consultation_revenue, 2) }}</div>
            </div>
            <div class="metric-card">
                <div class="metric-title">Investigation Revenue</div>
                <div class="metric-value money">${{ number_format($investigation_revenue, 2) }}</div>
            </div>
            <div class="metric-card">
                <div class="metric-title">Medication Revenue</div>
                <div class="metric-value money">${{ number_format($medication_revenue, 2) }}</div>
            </div>
        </div>
        ...
        <div class="payment-methods">
            ...
            <div class="payment-method-row">
                ...
                <span><strong>${{ number_format($data['amount'], 2) }}</strong></span>
            </div>
            @endforeach
        </div>
        ...
        <div class="category-section">
            <div class="category-header">
                ...
                <span class="category-total">
                    ...
                    ${{ number_format($categoryTransactions->sum('amount'), 2) }}
                </span>
            </div>
        ...
        <div class="summary-box">
            ...
            <div class="summary-row">
                ...
                <span class="summary-amount">${{ number_format($total_revenue, 2) }}</span>
            </div>
            <div class="summary-row">
                <span class="summary-label">Patient Direct Payments:</span>
                <span class="summary-amount">${{ number_format($patient_payments, 2) }}</span>
            </div>
            <div class="summary-row">
                <span class="summary-label">Insurance Covered Amount:</span>
                <span class="summary-amount">${{ number_format($insurance_payments, 2) }}</span>
            </div>
