    ...
    <div class="statement-container">
            ...
            <table class="transactions-table">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #f8f9fa; font-weight: bold;">
                        ...
                        <td class="amount">Tsh {{ number_format($categoryTransactions->sum('amount'), 2) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="summary-box">
            ...
            <div class="summary-row">
                ...
                <span class="summary-amount">Tsh {{ number_format($total_amount, 2) }}</span>
            </div>
            <div class="summary-row">
                <span class="summary-label">Insurance Coverage:</span>
                <span class="summary-amount">Tsh {{ number_format($total_insurance, 2) }}</span>
            </div>
            <div class="summary-row grand-total">
                <span class="summary-label">Patient Payments:</span>
                <span class="summary-amount">Tsh {{ number_format($total_patient_paid, 2) }}</span>
            </div>
        </div>
            ...
            <table class="transactions-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="amount">Tsh {{ number_format($methodTransactions->sum('amount'), 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
