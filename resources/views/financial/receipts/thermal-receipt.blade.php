...
<body>
    <div class="receipt-container">
        ...
        <div class="item-row">
            ...
            <span class="item-price">Tsh {{ number_format($item['total_price'], 2) }}</span>
        </div>
        @endforeach
        ...
        <div class="total-row">
            <span>SUBTOTAL:</span>
            <span>Tsh {{ number_format($payment_details['total_amount'], 2) }}</span>
        </div>
        
        @if($payment_details['insurance_covered'] > 0)
        <div class="total-row">
            <span>INSURANCE:</span>
            <span>-Tsh {{ number_format($payment_details['insurance_covered'], 2) }}</span>
        </div>
        @endif
        
        <div class="total-row">
            <span>TOTAL PAID:</span>
            <span>Tsh {{ number_format($payment_details['patient_paid'], 2) }}</span>
        </div>
