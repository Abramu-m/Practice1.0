    ...
    <div class="grn-summary">
        ...
        <div class="grn-info">
            ...
            <div class="grn-totals">
                <h4>Tsh {{ number_format($grn->total_amount, 2) }}</h4>
    ...
    @if($grn->items->count() > 0)
        <div class="quick-stats">
            ...
            <div class="stat-item">
                ...
                <span class="stat-value">Tsh {{ number_format($grn->items->sum('total_cost'), 2) }}</span>
            </div>
            
            <div class="stat-item">
                <span>Total Discount:</span>
                <span class="stat-value text-danger">Tsh {{ number_format($grn->items->sum('discount_amount'), 2) }}</span>
            </div>
            
            <div class="stat-item">
                <span>Total Tax:</span>
                <span class="stat-value text-info">Tsh {{ number_format($grn->items->sum('tax_amount'), 2) }}</span>
            </div>
            
            <div class="stat-item">
                <span class="fw-bold">Net Amount:</span>
                <span class="stat-value text-success">Tsh {{ number_format($grn->items->sum('net_amount'), 2) }}</span>
            </div>
        </div>
    @endif
                        ...
                        <tbody>
                            @foreach($grn->items->take(5) as $item)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <strong>Tsh {{ number_format($item->net_amount, 2) }}</strong>
                                    </td>
                                    <td>
