        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="stat-item">
                    ...
                    @endphp
                    <div class="stat-number text-success">${{ number_format($totalValue, 0) }}</div>
            ...
            <div class="expiry-item priority-high">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="value-display small">${{ number_format($item->quantity_received * $item->unit_cost, 2) }}</div>
                    </div>
                    <div class="col-md-2">
