    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stat-card bg-success text-white">
                <div class="stat-number">Tsh {{ number_format($supplier->goodsReceivedNotes->where('status', 'approved')->sum('total_amount'), 2) }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stat-card bg-warning text-white">
                <div class="stat-number">Tsh {{ number_format($supplier->getPendingAmount(), 2) }}</div>
            ...
            <div class="info-card">
                ...
                <div class="info-card-body">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value">
                            <strong>Tsh {{ number_format($supplier->getPendingAmount(), 2) }}</strong>
                        </span>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach($recentGRNs as $grn)
                                        <tr>
                                            ...
                                            <td>Tsh {{ number_format($grn->total_amount ?? 0, 2) }}</td>
                                            <td>
