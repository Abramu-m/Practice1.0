    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('medications.reconciliation.corrections.process') }}" id="correctionForm">
                        @csrf
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="small text-muted">
                        ...
                        <a href="{{ route('medications.reconciliation.audit') }}" class="btn btn-outline-info btn-sm">
