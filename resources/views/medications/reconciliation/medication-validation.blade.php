                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        @if(isset($validation['status']) && $validation['status'] !== 'valid')
                            <a href="{{ route('medications.reconciliation.corrections.form') }}?medication_id={{ $medication->id }}"
                        ...
                        <a href="{{ route('medications.reconciliation.audit') }}?medication_id={{ $medication->id }}" 
...
function exportValidation() {
    ...
    const url = `{{ route('medications.reconciliation.export') }}?report_type=validation&format=pdf&medication_id=${medicationId}`;
