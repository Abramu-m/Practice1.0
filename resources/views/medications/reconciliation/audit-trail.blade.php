    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('medications.reconciliation.audit') }}">
                        <div class="row g-3">
                            <div class="col-md-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                ...
                                <a href="{{ route('medications.reconciliation.audit') }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            @if(request()->hasAny(['medication_id', 'location_id', 'movement_type', 'start_date', 'end_date']))
                                <a href="{{ route('medications.reconciliation.audit') }}" class="btn btn-outline-primary">
                                    <i class="fas fa-times me-2"></i>
                                    Clear Filters
                                </a>
                            @endif
...
function exportAuditTrail() {
    ...
    window.open(`{{ route('medications.reconciliation.export') }}?report_type=audit&format=pdf&${currentParams.toString()}`, '_blank');
}
